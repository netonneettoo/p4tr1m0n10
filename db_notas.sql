...
-- SHOW CREATE TABLE STATUS_PARCELA
CREATE TABLE `STATUS_PARCELA` (
    ID INT UNSIGNED NOT NULL AUTO_INCREMENT PRIMARY KEY,
    STATUS_PARCELA VARCHAR(45) NOT NULL,
    UNIQUE(STATUS_PARCELA)
);

-- INSERT INTO STATUS_PARCELA
INSERT INTO STATUS_PARCELA (ID, STATUS_PARCELA) VALUES (1, `EM ABERTO`);
INSERT INTO STATUS_PARCELA (ID, STATUS_PARCELA) VALUES (2, `PAGO`);
